      ...
      <div className='flex w-full flex-col items-center gap-10'>
        ...
        >
          <Input
            ...
            className='h-12 border-main-gray bg-white text-center rounded-lg focus-visible:ring-1 focus-visible:ring-main-gray text-base'
          />
          <Input
            type='password'
            placeholder='비밀번호'
          ...
          <Button
            type='submit'
            className='h-12 w-full bg-main-gray text-white hover:bg-black rounded-lg text-base'
          >
            시작하기
          </Button>
          {/* 하단 링크 */}
